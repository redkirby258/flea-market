...
<div class="register-form">
  ...
  <div class="register-form__inner">
    <form class="register-form__form" action="/register" method="post">
      ...
      <div class="register-form__group">
        <label class="register-form__label" for="confirm-password">確認パスワード</label>
        <input class="register-form__input" type="password" name="password" id="confirm-password" placeholder="例：coachtech1106">
        <!--<p class="register-form__error-message">
          @error('password')
          {{ $message }}
          @enderror
